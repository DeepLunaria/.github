...
* **Rainlink** – Lavalink client implementation
  → [https://github.com/RainyXeon/Rainlink](https://github.com/RainyXeon/Rainlink)
...
* **LavaStatusMonitor** – Monitoring & diagnostics for Lavalink nodes
  → [https://github.com/RainyXeon/LavaStatusMonitor](https://github.com/RainyXeon/LavaStatusMonitor)

* **ByteBlaze** – Stable first advanced discord music bot
  → [https://github.com/RainyXeon/ByteBlaze](https://github.com/RainyXeon/ByteBlaze)

* **Cylane** – [Archived] ByteBlaze's predecessor
  → [https://github.com/RainyXeon/Cylane](https://github.com/RainyXeon/Cylane)
